...
__all__ = [
    ...
    'OPTIONAL_REQUIREMENTS', 'DOCS_REQUIREMENTS', 'TESTS_REQUIREMENTS',
    'DEVELOPMENT_REQUIREMENTS'
]

SHORT_DESCRIPTION = 'Colour Science - Datasets'
...
if os.environ.get('READTHEDOCS') == 'True':
    INSTALLATION_REQUIREMENTS += [
        'numpy>=1.8.*', 'mock', 'sphinxcontrib-bibtex'
    ]
...
def get_version():
    ...
    with open(os.path.join('colour_datasets', '__init__.py')) as file_handle:
